...
import type { AIExtractedQuestion, ExtractionResult } from '@/lib/ai-question-extractor-new';

export default function QuestionExtractionTest() {
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select an image file containing MCQ questions to extract
            </CardDescription>
          </CardHeader>
        ...
        {extractionResult && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI-powered question extraction completed
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {extractionResult.debugInfo.length > 0 && (
                <div className="mt-6">
                  <h3 className="font-medium text-gray-800 mb-3">Debug Information:</h3>
                  <div className="bg-gray-900 text-gray-100 p-4 rounded-lg max-h-60 overflow-y-auto">
                    {extractionResult.debugInfo.map((log, index) => (
