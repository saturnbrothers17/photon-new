...
if (localResult.error) {
  ...
  if (result.error) {
    console.warn('⚠️  No .env.local or .env file found. Expecting environment variables to be set by the shell.');
  } else {
...
async function setupTeacherUser() {
  ...
  try {
    ...
    console.log('🔗 Faculty Portal: http://localhost:9002/faculty-portal');
